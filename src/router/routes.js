...
const routes = [
  {
    ...
    children: [
      ...
      { path: '/export/:type?', name: 'export', component: () => import('../pages/Export.vue') },
      ...
      { path: '/scheduledtxeditor/:id?', name: 'scheduledtxeditor', component: () => import(/* webpackChunkName: 'scheduledtxeditor' */'../pages/ScheduledTxEditor.vue') },
      { path: '/sync', name: 'sync', component: () => import('../pages/Sync.vue') },
      { path: '/tx/:id?', name: 'tx', component: () => import('../pages/Transaction.vue') },
